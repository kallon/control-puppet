...
class profiles::mco_profile::middleware::rabbitmq (
  $confdir                   = '/etc/rabbitmq',
  $vhost                     = $profiles::mco_profile::params::rabbitmq_vhost,
  ...
  $middleware_port           = $profiles::mco_profile::params::middleware_port,
  ...
  $middleware_admin_user     = $profiles::mco_profile::params::middleware_admin_user,
  $middleware_admin_password = $profiles::mco_profile::params::middleware_admin_password,
